    ...
    <sf:form action="newAcc" modelAttribute="user" method="post">
        <table border="0" cellpadding="5">
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="PPS" size="45"
                           value="<c:out value='${user.PPS}' />"
                    />
                </td>
                <td><sf:errors path="PPS" cssClass="error"/></td>
            </tr>
            <tr>
                <th>Address: </th>
                <td>
            ...
            <tr>
                <th>Nationality: </th>
                <td>
                    <select name="nationality" path="nationality">
                ...
                <td><sf:errors path="nationality" cssClass="error"/></td>
            </tr>
            <tr>
